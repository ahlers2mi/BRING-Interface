...
// Rezept-Grunddaten aus dem Video, unabhängig davon, wer den Text auswertet.
// **Kein `prep_time` aus der Videolänge**: ein 12-Minuten-Video ist kein
// 12-Minuten-Gericht. Die Zeit kommt aus dem Text oder gar nicht – sonst
// verfälscht sie das Zeitlimit beim Würfeln.
export function videoRecipeBase(source) {
  return {
    name: cleanVideoTitle(source.title),
    source_url: source.url,
    image_url: source.image,
    tags: ['Video', source.author].filter(Boolean),
  };
}
