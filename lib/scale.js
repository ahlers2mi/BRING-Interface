...
export function scaleAmountText(amount, factor) {
  ...
  // Zwei Angaben für dieselbe Zutat ("1 Dose oder 400 g", so entsteht es aus
  // "1 Dose Kokosmilch (ca. 400 g)"). Beide umrechnen – sonst fällt die zweite
  // beim Umrechnen still weg.
