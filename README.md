...
- **Wochenplan mit Würfelfunktion** – einzelne Tage oder die ganze Woche auswürfeln lassen, Tage von Hand belegen, **auf einen frei gewählten anderen Tag verschieben** (Zieltag aus zwei Wochen wählen; ist dort schon etwas geplant, wird gefragt: mitschieben, tauschen oder ersetzen) und die Zutaten der kompletten Woche in einem Schritt nach Bring schieben. Gleiche Zutaten werden dabei **addiert** (aus „½ TL + 1 TL + 1 TL" wird „2½ TL"), und was in der Vorratsliste auf „da" steht, bleibt weg – der Grundstock muss nicht jede Woche mit. Was weggelassen wurde, steht unter der Liste.
