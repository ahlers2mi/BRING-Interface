...
- **Vorräte** – eine Liste dessen, was im Haus sein *soll*, mit Zustand **da / knapp / leer**. „Grundstock anlegen" füllt Salz, Pfeffer, Mehl, Öl, Brühe & Co. auf einen Klick ein, „Fehlendes auf die Liste" schiebt alles Knappe und Leere nach Bring, „Alles wieder da" setzt nach dem Einkauf zurück. Je Vorrat lässt sich eine Menge hinterlegen, die dann auf der Bring-Liste steht.
