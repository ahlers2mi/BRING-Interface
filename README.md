...
- **Vorräte** – eine Liste dessen, was im Haus sein *soll*, mit Zustand **da / knapp / leer**. „Grundstock anlegen" füllt Salz, Pfeffer, Mehl, Öl, Brühe & Co. auf einen Klick ein, „Fehlendes auf die Liste" schiebt alles Knappe und Leere nach Bring, „Alles wieder da" setzt alles zurück. **Abhaken in der Bring-App genügt:** verschwindet ein Vorrat von der Liste und taucht unter „zuletzt gekauft" auf, steht er automatisch wieder auf „da". Je Vorrat lässt sich eine Menge hinterlegen, die dann auf der Bring-Liste steht.
...
- **Rezeptverwaltung** – Rezepte mit Zutaten, Tags, Portionen, Link, Zubereitung und voraussichtlicher Zeit speichern und per Klick in eine Bring-Liste importieren. **„🧺 Wieder rausnehmen"** ist der Gegenweg, wenn ein Tag umgeplant wurde: es zeigt erst, welche Artikel von der Liste verschwinden würden, und entfernt sie beim zweiten Klick. Fremdes bleibt liegen, und was als Vorrat auf der Liste steht (weil es leer ist), auch. Im Wochenplan steht derselbe Knopf am Tag – dort, sobald „🛒 eingekauft" dransteht.
- **Wochenplan mit Würfelfunktion** – einzelne Tage oder die ganze Woche auswürfeln lassen, Tage von Hand belegen, **auf einen frei gewählten anderen Tag verschieben** und die Zutaten der kompletten Woche in einem Schritt nach Bring schieben. Gleiche Zutaten werden dabei **addiert** (aus „½ TL + 1 TL + 1 TL" wird „2½ TL"), und was in der Vorratsliste auf „da" steht, bleibt weg – der Grundstock muss nicht jede Woche mit. Was weggelassen wurde, steht unter der Liste.
- **Verschieben mit Rückfrage** – der Zieltag wird gewählt, von drei Tagen zurück bis zum Ende der Folgewoche. Steht dort schon etwas, kommt die Frage: **mitschieben** (der Zieltag und alles dahinter rücken auf, nichts geht verloren), **tauschen** oder **ersetzen**. Die Tage rückwärts sind zum **Nachpflegen**, wenn doch etwas anderes gekocht wurde – der Plan ist die Grundlage des gelernten Geschmacks, also lohnt es, ihn stimmig zu halten.
...
- **Nach dem Import gleich einplanen** – entsteht bei einem Import **genau ein** Rezept, steht unter der Erfolgsmeldung „Gleich einplanen?": ein Klick, ein Tag aus den nächsten zwei Wochen, fertig. Auch bei einer Dublette („kennen wir schon") – einplanen will man das Rezept dann meist trotzdem.
...
- **Reste-Küche** – eingeben, was noch im Kühlschrank liegt, und passende Rezepte nach Abdeckung sortiert finden; fehlende Zutaten wandern auf Wunsch direkt nach Bring. Der Haken „Vorräte annehmen" rechnet mit der **eigenen Vorratsliste**: als vorhanden gilt, was dort auf „da" steht – ist das Öl leer, taucht es als fehlende Zutat auf.
- **KI-Rezeptanalyse** – kompletten Rezepttext einfügen **oder Screenshots/Fotos hochladen** (bis zu vier, die zusammen ein Rezept zeigen); ein KI-Modell (über [OpenRouter](https://openrouter.ai/)) liest Name, Beschreibung, Zutaten (mit Mengen) und Zubereitung heraus. Der Rückfall für Seiten, die sich nicht auslesen lassen – läuft Mealie, wird das Ergebnis direkt dort angelegt. Optional lässt sich dazu ein **Vorschaubild** hochladen (ein Foto vom fertigen Gericht); aus den Screenshots selbst entsteht keins, die zeigen ja Zutaten und Zubereitung.
